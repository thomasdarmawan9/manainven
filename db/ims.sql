...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2021 at 09:06 AM
...
INSERT INTO `deliveryorder` (`deliveryOrderID`, `salesOrderID`, `productID`, `qty`, `deliveryDate`) VALUES
(1, 1, 1, 0, '2020-11-03'),
(2, 2, 2, 1, '2020-11-01'),
(3, 4, 3, 7, '2021-01-10'),
(4, 1, 2, 10, '2021-01-10'),
...
INSERT INTO `sales_product` (`sales_productID`, `salesOrderID`, `productID`, `qty`) VALUES
(1, 5, 4, 3),
(2, 6, 1, 7),
(3, 7, 4, 3),
(4, 8, 1, 10);
...
(1, 'Juwita Ginting', 'owner', 'password', 'Owner', '2020-11-06', NULL),
(2, 'Doni', 'staff_1', 'staff1', 'Staff', '2020-11-06', NULL),
(3, 'Desqy', 'staff_2', 'staff2', 'Staff', '2020-11-06', NULL),
(4, 'Admin', 'Admin', 'admin', 'Admin', '2021-01-10', NULL);
...
ALTER TABLE `sales_product`
  ADD PRIMARY KEY (`sales_productID`),
  ADD KEY `productID` (`productID`);
...
--
ALTER TABLE `deliveryorder`
  MODIFY `deliveryOrderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `sales_product`
  MODIFY `sales_productID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `deliveryorder`
  ADD CONSTRAINT `deliveryorder_ibfk_1` FOREIGN KEY (`salesOrderID`) REFERENCES `salesorder` (`salesOrderID`),
  ADD CONSTRAINT `deliveryorder_ibfk_2` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);
...
--
ALTER TABLE `sales_product`
  ADD CONSTRAINT `sales_product_ibfk_2` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`);
COMMIT;
