        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Retur ID : <?php echo $retur['retur_id']; ?></span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="d-flex justify-content-between pt-6">
                                                    <div class="d-flex flex-column flex-root">
                                                        ...
                                                        <span class="opacity-70"><?php echo $retur['orderDate']; ?></span>
                                                    </div>
                                                    <div class="d-flex flex-column flex-root">
                                                        <span class="font-weight-bolder mb-2">Alamat</span>
                                                        <span class="opacity-70"><?php echo $retur['alamat']; ?></span>
                                                    </div>
                                                    <div class="d-flex flex-column flex-root">
                                                        <span class="font-weight-bolder mb-2">Nama Produk</span>
                                                        <span class="opacity-70"><?php echo $retur['nama_produk']; ?>
                                                        
                                                    </div>
                                                    <div class="d-flex flex-column flex-root">
                                                        <span class="font-weight-bolder mb-2">Jumlah</span>
                                                        <span class="opacity-70"><?php echo $retur['jumlah']; ?>
                                                        
                                                    </div>
                                                    <div class="d-flex flex-column flex-root">
                                                        <span class="font-weight-bolder mb-2">Alasan</span>
                                                        <span class="opacity-70"><?php echo $retur['alasan']; ?>
