		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<!--begin::Details-->
				<div class="d-flex align-items-center flex-wrap mr-2">
					<!--begin::Title-->
					<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Delivery Order</h5>
					<!--end::Title-->
					<!--begin::Separator-->
						...
						<ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
							...
							<li class="nav-item mr-3">
								<a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
									...
									<span class="nav-text font-size-lg">Deliver Order</span>
								</a>
							</li>
                            <!--end::Item-->
                        </ul>
							    ...
							    <div class="row">
									...
									<div class="col-xl-7 my-2">
										...
										<div class="row">
											...
											<div class="col-9">
												<h6 class="text-dark font-weight-bold mb-10">Delivery Order Info:</h6>
											</div>
										</div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                                        ...
                                        <!--begin::Group-->
                                        <div class="form-group row">
											<label class="col-form-label col-3 text-lg-right text-left">Delivery Date</label>
												<div class="col-9">
													<input class="form-control form-control-lg form-control-solid datepicker" type="date" name="deliveryDate" id="deliveryDate"/>
                                                    <small class="form-text text-danger"><?php echo form_error('deliveryDate');?></small>
                                                </div>
										</div>
										<!--end::Group-->											
                                        </div>
							    ...
							    <div class="row">
									...
									<div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-2">
                                                <input class="form-control form-control-lg form-control-solid" type="numeric" name="qty" id="qty" placeholder="Qty"/>
												<small class="form-text text-danger"><?php echo form_error('qty');?></small>
											</div>
										</div>
                                        <!--end::Group-->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <a href="<?php echo base_url(); ?>delivery" class="btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
