	...
	<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center">
				...
				<!--begin::Button-->
				<a href="<?php echo base_url(); ?>inventory" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
				<!--end::Button-->
				<!--begin::Dropdown-->
						...
						<ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
							...
							<li class="nav-item mr-3">
								<a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
									...
									<span class="nav-text font-size-lg">Warehouse A</span>
								</a>
							</li>
							<!--end::Item-->
                        </ul>
							    ...
							    <div class="row">
									...
									<div class="col-xl-7 my-2">
										...
										<div class="row">
											...
											<div class="col-9">
												<h6 class="text-dark font-weight-bold mb-10">Product Warehouse A</h6>
											</div>
										</div>
                                        <!--end::Row-->
                                        <!--begin::Group-->
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="customerID" id="customerID">
                                <?php foreach ($customer as $cust) :?>
                                    <?php if($cust == $inventory['customer']) : ?>
